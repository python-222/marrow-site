  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none"
        style={{ width: "600px", height: "600px", background: "radial-gradient(circle, rgba(91,82,240,0.06) 0%, transparent 70%)" }}
      />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center flex flex-col items-center gap-8 pt-16 pb-20">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          <Link
            ...
            className="group px-10 py-4 rounded-xl text-base font-bold text-white transition-all hover:scale-105 hover:shadow-2xl"
        ...
        <div className="w-full mt-4 overflow-hidden" style={{ maskImage: "linear-gradient(90deg, transparent, black 15%, black 85%, transparent)" }}>
          <div className="flex gap-3 animate-[marquee_25s_linear_infinite]" style={{ width: "max-content" }}>
